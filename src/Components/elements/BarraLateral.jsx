    ...
    return (
        ...
        <section className="barra-lateral">
            ...
            <ul className="barra-lateral__nav">
                <li className="barra-lateral__nav-item"><button className="barra-lateral__nav-btn"><img src="../src/img/home.png#" alt="home" className="barra-lateral__nav-icon-img" /><span className="barra-lateral__nav-label" onClick={() => navigate("/")}>Home</span></button></li>
                ...
                <li className="barra-lateral__nav-item"><button className="barra-lateral__nav-btn"><img src="../src/img/profile.png#" alt="Profile" className="barra-lateral__nav-icon-img_Profile" /><span className="barra-lateral__nav-label" onClick={() => navigate("/miperfil")}>Profile</span></button></li> 
